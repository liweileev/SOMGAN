'''
Author: Liweileev
Date: 2022-01-04 11:27:20
LastEditors: Liweileev
LastEditTime: 2022-01-20 21:53:25
'''
    ...
    def __init__(self,
        ...
        **block_kwargs,             # Arguments for SynthesisBlock.
        ...
        if img_resolution == 96:
            ...
            self.img_resolution = img_resolution
            self.img_channels = img_channels
            self.block_resolutions = [6, 12, 24, 48 ,96]
            channels_dict = {res: min(channel_base // res, channel_max) for res in self.block_resolutions}
            fp16_resolution = 24

            self.num_ws = 0
            for res in self.block_resolutions:
                in_channels = channels_dict[res // 2] if res > 6 else 0
...
class MappingNetwork(torch.nn.Module):
    def __init__(self,
        ...
        features_list = [z_dim] + [w_dim] * (num_layers - 1) + [w_dim]
